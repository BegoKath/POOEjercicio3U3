...
public class vtnPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mniReporteCalificaciones.setText("Reporte de Calificiones");
    ...
    private void mniReporteCalificacionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniReporteCalificacionesActionPerformed
        try {
            frmReporteCalificaciones calificaciones = new frmReporteCalificaciones();
            this.jDesktopPane1.add(calificaciones);
            calificaciones.show();
        } catch (Exception ex) {
            Util.imprimir(ex.toString());
        }
